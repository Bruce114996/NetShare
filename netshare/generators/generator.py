...
class Generator(object):
    def __init__(self, config):
        ...
        print("default config path is ", default_configs.__path__)
        ...
        #pre_post_processor_class ="NetsharePrePostProcessor"
    ...
    def visualize(self, work_folder):
        ...
        print("columns are ", synthetic_data.columns)
        print(real_data[synthetic_data.columns])
