...
class NetsharePrePostProcessor(PrePostProcessor):
    def _pre_process(self, input_folder, output_folder, log_folder):
        ...
        if os.path.isfile(input_folder):
            ...
            print("Pre Process's output of input folder is ", input_folder)
        ...
        if self._config["dataset_type"] == "pcap":
            ...
            ## have error if ends with other type of file
            else:
                raise ValueError(
        ...
        for i, field in enumerate(
            ...
            print("list of df column is ", list(set(df[field.column])))
            print("field choices are ", getattr(field, 'choices', list(set(df[field.column])))) 
